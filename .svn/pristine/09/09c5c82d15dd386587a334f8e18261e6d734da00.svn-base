...
public class FinishActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		maze = StateHolder.completedMaze;
		skillLevel = getIntent().getIntExtra("skillLevel", 0);
		instructions = (TextView) findViewById(R.id.instructions);
		instructions.setText(message + " To play again, press the home button.");
		energyConsumed = (TextView) findViewById(R.id.energyConsumed);
		energyConsumed.setText("Energy consumed: " + StateHolder.energyConsumed);
		pathLength = (TextView) findViewById(R.id.pathLength);
		pathLength.setText("Path length: " + StateHolder.stepsTaken);
	}
