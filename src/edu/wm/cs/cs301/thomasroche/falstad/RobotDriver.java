...
public interface RobotDriver {
	...
	boolean drive2Exit() throws RobotStoppedException, HitObstacleException, RobotOutOfEnergyException;
	...
	/**
	 * Returns a boolean value indicating if the robot can see the goal in any
	 * direction. This is used by the robot driver algorithms for Wizard and for
	 * CuriousMouse.
	 * @throws RobotOutOfEnergyException |
	 * @throws HitObstacleException 
	 */

	boolean checkIfCanSeeExit() throws RobotOutOfEnergyException, HitObstacleException;
}
